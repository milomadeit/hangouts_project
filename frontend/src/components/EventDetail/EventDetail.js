  ...
  return (
    <div>
      ...
      <div className='upper-event-details'>
        <div className='event-detail-thumbnail-div'>
          <img
        ...
        <div className='event-info-div'>
          <p>
            ...
            <span className='group-dot'>·</span> {event.startDate.slice(11, 16)}
          </p>
          <p>
            End {event.endDate.slice(0, 10)}{" "}
            <span className='group-dot'>·</span> {event.endDate.slice(11, 16)}
          </p>
          <p>{event.price}</p>
          <p>{event.type}</p>
        </div>
