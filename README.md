...
* Request
  * Method: `POST`
  * URL: `/groups/:id/request-membership`
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: `PUT`
  * URL: `/groups/:groupId/:userId/change-membership-status`
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: `POST`
  * URL: `/events/:id/request-attendance`
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: `PUT`
  * URL: `events/:id/change-attendance-status`
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: `DELETE`
  * URL: `/events/:eventId/attendance/:userId`
  * Headers:
    * Content-Type: application/json
  * Body:
