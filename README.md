...
* Request
  * Method: `PUT`
  * URL: `/api/groups/:groupId/change-membership-status`
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: `DELETE`
  * URL: `/api/groups/:groupId/cancel-membership`
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: `POST`
  * URL: `/api/events/:eventId/request-attendance`
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: `PUT`
  * URL: `/api/events/:eventId/change-attendance-status`
  * Headers:
    * Content-Type: application/json
  * Body:
